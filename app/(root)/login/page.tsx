...
const Home = () => {
    console.info("hnaaaaa loggihoum")
                    ...
                    <div className="py-10">
                        ...
                        <div className="flex flex-col items-center">
                            <input type="email" placeholder="Email"
                                   className="outline-none border-2 border-gray-200 text-black rounded-lg py-2 px-4 w-96 mb-3"/>
                            ...
                            <div className="flex w-96 justify-between items-center text-gray-800 mt-5">
                                <label className="flex text-xs"><input type="checkbox"
                                                                       className="flex items-center mr-1"/>Remember
                                    me</label>
